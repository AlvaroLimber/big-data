...
-   Cuando termine envíe su respuesta al correo [achirinog\@fcpn.edu.bo](mailto:achirinog@fcpn.edu.bo){.email}
...
$$\sum_{i=1}^{20}{\sum_{j=2}^5{\frac{i^3}{2+ij}}}$$ \* (2pts) Crear una función que dado un vector numérico devuelva el coeficiente de variación y el coeficiente de asimetría de Pearson y Fisher.
...
Del enlace: <https://www.dismac.com.bo/lo-que-te-regalarias-si-fueras-ni-no.html> arme una base de datos utilizando las primeras 2 páginas que contenga las siguientes variables: + Identificador + Descripción + Precio actual
