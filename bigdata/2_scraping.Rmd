...
bd2<-gtrends("Bolivia",time = "today 3-m")
View(bd2$interest_over_time)

bd3<-gtrends("Bolivia",time = "now 1-d")
View(bd3$interest_over_time)

aux<-countries

bd4<-gtrends("Dolar",geo=c("BO") ,time = "today 3-m")
View(bd4$interest_over_time)

plot(bd4)

bd5<-gtrends(c("Dolar","Euro"),geo=c("BO") ,time = "today 3-m")
View(bd5$interest_over_time)
plot(bd5)
```
...
t1<-wb_data(country = c("BOL","PER"),indicator = "NY.GDP.MKTP.CD", start_date = 2000, end_date = 2020)
...
=======
>>>>>>> d78afd4a46588ef015b2f5625d3b312e8fdd02a1
